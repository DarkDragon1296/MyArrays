...
setup: main.o Menu.o StandArr.o OtherOperations.o
	$(CC) $(TARGET_DIR)main.o $(TARGET_DIR)Menu.o $(TARGET_DIR)StandArr.o $(TARGET_DIR)OtherOperations.o -o $(TARGET_FILE)
	mv $(TARGET_FILE) $(TARGET_DIR)

main.o: main.cpp Menu.h StandArr.h OtherOperations.h
	mkdir -p $(TARGET_DIR)
	$(CC) $(CFLAGS) main.cpp
